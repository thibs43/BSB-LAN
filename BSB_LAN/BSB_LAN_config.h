...
*/
uint8_t network_type = WLAN;             // Set to LAN (0) when using Ethernet connection. Set to WLAN (1) when using WiFi.
...
char wifi_ssid[32] = "Laura&Thib"; // enter your WiFi network name (SSID) here
char wifi_pass[64] = "esisarforever";// enter your WiFi password here
...
char mDNS_hostname[32] = "BSBLAN";     // Advertises the hostname in the local network. Set this to an empty string if you don't want your device to be found under this name in your network.
